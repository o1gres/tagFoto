...
public class Main {
	...
	private static void listFilesForFolder (final File folder) throws ImageReadException, IOException  {
		 for (final File fileEntry : folder.listFiles()) {
		        if (fileEntry.isDirectory()) {
		            ...
		            try {
		            //richiamo metadataExample
		            	System.out.println("Pippo");	
		            metadataExample(fileEntry);
		            } catch (IOException e) {
		            	System.out.println("Errore chiamando il metodo metadataExample \n");
		            	e.printStackTrace();
		            	}
		        }
		    }		
